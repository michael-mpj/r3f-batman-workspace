 ...
 * File: chunk-XVTONTDZ.js
 * Description: chunk-XVTONTDZ component/utility
  ...
  useEventListener(
    ...
    () => {
      ...
      return (_focused.value =
        (_c = (_b = (_a = targetElement.value) == null ? void 0 : _a.matches) == null ? void 0 : _b.call(_a, PSEUDO_CLASS_FOCUS_WITHIN)) !=
        null
          ? _c
          : false);
    },
...
function useScroll(element, options = {}) {
  ...
  const setArrivedState = target => {
    ...
    const right =
      Math.abs(scrollLeft * directionMultipler) + el.clientWidth >= el.scrollWidth - (offset.right || 0) - ARRIVED_STATE_THRESHOLD_PIXELS;
  ...
  const _init = () => {
    ...
    ws.onclose = ev => {
      ...
      if (!explicitlyClosed && options.autoReconnect && (wsRef.value == null || ws === wsRef.value)) {
        ...
        const checkRetires =
          typeof retries === "function" ? retries : () => typeof retries === "number" && (retries < 0 || retried < retries);
...
//# sourceMappingURL=chunk-XVTONTDZ.js.map
