...
export default [
  // Global ignores MUST be first and in a separate config object
  {
    ignores: [
      ...
      "**/.vercel/**",
      "**/storybook-static/**",
      // Ignore specific build outputs that are being linted
      "apps/cyber-forge/dist/**",
      "projects/R3f-StarterKit/dist/**",
      "packages/*/dist/**",
      // Ignore all generated/minified files
      "**/*.min.js",
      "**/*.bundle.js",
      "**/*.chunk.js",
      "**/assets/*.js",
  ...
  // Node.js scripts configuration
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        Buffer: "readonly",
        global: "readonly",
        // Add additional Node.js globals that might be used
        module: "readonly",
        exports: "readonly",
        Promise: "readonly",
