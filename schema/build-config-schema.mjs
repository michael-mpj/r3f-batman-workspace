...
for (const rule of rules) {
  ...
  const scheme = {
    description: `${rule.names.join("/")} : ${rule.description} : ${rule.information}`,
    type: "boolean",
    default: true,
  };
  let custom = true;
    ...
    case "MD055":
      scheme.properties = {
        style: {
          ...
          type: "string",
          enum: ["consistent", "leading_only", "trailing_only", "leading_and_trailing", "no_leading_or_trailing"],
          default: "consistent",
        },
      };
      break;
